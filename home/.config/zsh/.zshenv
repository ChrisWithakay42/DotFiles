...
# zsh's own state. ZDOTDIR is set by the bootstrap stub in ~/.zshenv.
# HISTFILE and SHELL_SESSION_DIR are NOT set here: /etc/zshrc overrides both
# unconditionally, so they are set in .zshrc, which runs after it.
